...
export function TransferModal({ open, onOpenChange }: TransferModalProps) {
  ...
  const tokens = [
    { name: "USDC", logo: "https://altcoinsbox.com/wp-content/uploads/2023/01/usd-coin-usdc-logo-600x600.webp", address: fiatTokenAddresses.USDC },
    { name: "USDT", logo: "https://altcoinsbox.com/wp-content/uploads/2023/01/tether-logo-600x600.webp", address: fiatTokenAddresses.USDT },
  ];
  ...
  }, [formData.amount, selectedToken.name, usdcPrice, usdtPrice]);
